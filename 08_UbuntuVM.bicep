...
param vmName string = 'mgbcpLinuxVM'
...
@secure()
param adminPasswordOrKey string = 'Qwertyuiop123!'
...
param virtualNetworkName string = 'MGBCPvNet'

@description('Name of the subnet in the virtual network')
param subnetName string = 'MGBCPSubnet'

@description('Name of the Network Security Group')
param networkSecurityGroupName string = 'MGBCPSecGroupNet'
